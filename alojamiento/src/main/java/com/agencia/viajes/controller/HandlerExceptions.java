...
public class HandlerExceptions {
    ...
    @ExceptionHandler(AlojamientoNoEncontradoException.class)
    public ResponseEntity<Respuesta<String>> capturarAlojamientoNoEncontradoException(AlojamientoNoEncontradoException e){
